// Simple MongoDB script to create email template
// Run with: mongo <database_name> create-email-template-mongo.js
// Or use MongoDB Compass / Studio 3T to run this
...
print("Email template 'new_template' created successfully!");
